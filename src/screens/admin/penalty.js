...
const Penalty = () => {
  ...
  const tableHead = ['ECNO', 'Date', 'Employee Name', 'Intime', 'Late Mins', 'Amount'];
  const tableData = [
    ['001', '12/07/2024', 'John Doe', '09:10', '10', '$5'],
    ['002', '12/07/2024', 'Jane Smith', '09:15', '15', '$7.5'],
    ['003', '12/07/2024', 'Robert Brown', '09:05', '5', '$2.5'],
  ];

  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerText}>Late/Early Penalty Report</Text>
      </View>
